...
export default function CaseGeneratorModal({ isOpen, onClose, onCaseCreated }) {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-md flex items-center justify-center p-4 font-mono">
      <div className="w-full max-w-2xl glass-panel p-6 rounded-2xl border border-cyber-cyan/50 shadow-2xl">
        ...
        {activeTab === 'import_text' && (
          <div className="space-y-3">
            ...
            <textarea
              ...
              placeholder="Paste raw text from a real unsolved news story or police report. Groq AI will extract the 5 suspects, timeline, clues, and build the interactive pinboard automatically..."
              rows={6}
